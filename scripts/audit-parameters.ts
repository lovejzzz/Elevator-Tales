...
type Params = Partial<{
 energy:number; capacity:number; stressCap:number; fatigueEvery:number;
...
const variants:Record<string,Params>={
 baseline:{}, energy18:{energy:18}, energy22:{energy:22}, energy24:{energy:24},
 capacity20:{capacity:20}, capacity28:{capacity:28}, stress12:{stressCap:12}, stress18:{stressCap:18},
 fatigue25:{fatigueEvery:25}, fatigue35:{fatigueEvery:35}, threshold50:{threshold:'1 / 2'}, threshold80:{threshold:'4 / 5'},
 noSparseRelief:{sparseRelief:0}, crowdFrom5:{crowdedAt:5}, fares85:{fareScale:.85}, fares115:{fareScale:1.15},
 charge1:{chargePrice:1}, charge3:{chargePrice:3}, cooperation1:{cooperation:1}, cooperation5:{cooperation:5},
 inflation8:{shopInflation:8}, inflation16:{shopInflation:16}, calm25:{calmPrice:25}, calm45:{calmPrice:45},
 calmCap2:{calmCap:2}, calmCap4:{calmCap:4}, calmRelief4:{calmRelief:4}, calmRelief8:{calmRelief:8},
 rest1:{restCap:1}, rest5:{restCap:5}, patienceMinus1:{patience:-1}, patiencePlus1:{patience:1},
 weight8:{weightCap:8}, weight12:{weightCap:12}, dismissHalf:{dismissalScale:.5}, dismiss150:{dismissalScale:1.5},
 loverCall0:{loverCall:0}, loverCall50:{loverCall:.5}, bombFuse2:{bombMin:2}, bombFuse4:{bombMin:4},
 // Combined hypotheses are selected for confirmation, not mixed into OFAT.
 reliefAndCoop:{calmRelief:4,cooperation:5}, crowdAndCoop:{crowdedAt:5,cooperation:5},
};
...
const reportDir=resolve(process.env.ELEVATOR_AUDIT_OUTPUT??join(root,'docs/parameter-audit-2026-09-03'),phase);
...
const seedBase=phase==='holdout'?903690011:903193409;
