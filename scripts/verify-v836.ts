...
// v8.37 replaces the overflow-only item with the8-coin capped Flywheel.
assert.deepEqual(UPGRADE_BASE_PRICES,{battery:30,capacity:35,calm:35,concierge:40,reinforced:45,express:45,tipjar:30,relay:30,crowd:24,meter:25,rails:24,insulation:24,reservation:20,single:24,delay:24,buffer:8,soundproof:24,retime:24,punchcard:24,finale:24});
