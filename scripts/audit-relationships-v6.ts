...
import { PASSENGERS, PASSENGER_ORDER, ADJACENT, type PassengerKind } from '../experiments/v6/game-data';
import { initialRun, resolveFloor, totalWeight, energySavings, dismissRider, type Rider, type RunState } from '../experiments/v6/game-engine';
import { BONDS, bondStatus, randomTraits, riderProfile } from '../experiments/v6/rider-profile';
import { activeConnection, conflictingConnection, planPlacement } from '../experiments/v6/game-interaction';
import { energyForecast, stressForecast } from '../experiments/v6/game-forecast';
import { passengerBrief } from '../experiments/v6/passenger-presentation';
...
const output={source:'f59e02c7cea65e56ef4dba61233a10a7e7444525',resolves,forecastChecks,
