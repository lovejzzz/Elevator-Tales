...
const MANUAL: Array<[string, string, string, string]> = [
  ...
  ['三个数字', '每位乘客只看车费、每层耗电和躁动。每层耗电＝电梯运转＋乘客耗电−节能（安静和幽冥的绿线也省电）。', 'Three numbers', 'Every rider has a fare, power per floor and agitation. Power per floor = motor + riders − savings (Quiet and Spirit green links save power too).'],
