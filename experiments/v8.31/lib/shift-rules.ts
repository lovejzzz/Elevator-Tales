...
export function riskPartnerships(cabin: Array<Rider | null>) {
  const contained = (slot: number) => {
    ...
    const controls = kind === 'drunk' ? ['nurse', 'musician'] : kind === 'thief' ? ['cop', 'lawyer'] : ['cop'];
...
export const OFFER_PARTNERS: Record<PassengerKind, PassengerKind[]> = {
  commuter: ['courier', 'coach'], tourist: ['commuter', 'celebrity', 'tourist'],
  courier: ['mechanic', 'commuter'], mechanic: ['courier', 'inspector'], lover: ['lover'],
  musician: ['drunk', 'child', 'thief'], thief: ['cop', 'lawyer', 'thief', 'drunk'],
  cop: ['thief', 'bomb'], lawyer: ['thief'], drunk: ['nurse', 'musician', 'thief', 'bomb'],
  nurse: ['drunk', 'child'], child: ['nurse', 'lover'], ghost: ['exorcist'], exorcist: ['ghost'],
  coach: ['commuter', 'courier'], celebrity: ['tourist', 'coach'], inspector: ['mechanic'],
  bomb: ['cop', 'thief', 'drunk'], mystery: ['lawyer'], shifter: ['nurse'], mimic: ['tourist'],
};
