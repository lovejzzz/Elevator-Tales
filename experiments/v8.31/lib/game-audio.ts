...
export type GameSound = 'select' | 'place' | 'combo' | 'depart' | 'arrive' | 'danger' | 'upgrade' | 'victory' | 'coin' | 'charge' | 'drain' | 'relief' | 'pressure' | 'load' | 'unload' | 'rare' | 'debut';
...
export function playGameSound(enabled: boolean, type: GameSound, delay = 0) {
  ...
  try {
    ...
    const notes: Record<GameSound, number[]> = { select: [440], place: [330, 440], combo: [523.25, 659.25, 783.99], depart: [220, 165], arrive: [659.25, 523.25], danger: [196, 164.81], upgrade: [392, 523.25, 659.25], victory: [392, 523.25, 659.25, 783.99], coin: [1046.5, 1318.5], charge: [392, 587.33], drain: [293.66, 220], relief: [523.25, 783.99], pressure: [174.61, 164.81], load: [246.94], unload: [369.99], rare: [880, 1108.73], debut: [523.25, 783.99, 1046.5] };
