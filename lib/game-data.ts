...
export const PASSENGERS: Record<PassengerKind, PassengerSpec> = {
  ...
  tourist: { kind: 'tourist', name: '游客', title: 'The Tourist', weight: 2, fare: 18, energy: 1, trip: [4, 7], patience: 3, rarity: 10, sheet: '01', cell: 1, tone: 'steady', short: '任何相邻乘客：每站+1币，逐人叠加', detail: '基础车费18。任何相邻乘客都让游客每层多赚1金币，包括其他游客；不设人数上限，由站位决定最大3位。邻座变化时立即重新计算。' },
  ...
  mechanic: { kind: 'mechanic', name: '维修工', title: 'The Mechanic', weight: 2, fare: 7, energy: 2, trip: [3, 7], patience: 3, rarity: 3, sheet: '01', cell: 3, tone: 'support', short: `每层节能${MECHANIC_SAVING}电 · 可堆叠`, detail: `每位维修工每层抵消${MECHANIC_SAVING}点人物耗电，多位逐个叠加。维修工本人耗2电；节能最多抵完人物耗电，不能抵消电梯运转的1电，也不会倒充电。` },
  ...
  musician: { kind: 'musician', name: '音乐家', title: 'The Musician', weight: 2, fare: 14, energy: 2, trip: [2, 5], patience: 3, rarity: 4, sheet: '01', cell: 5, tone: 'social', short: '所有相邻乘客：每层各抵消2躁动', detail: '稀有的短期控场核心：音乐向四周扩散，所有相邻乘客每层各抵消2点躁动，但自身每层耗2电。也能阻止相邻醉汉与儿童的负面效果；多位音乐家可逐人叠加。' },
  thief: { kind: 'thief', name: '小偷', title: 'The Thief', weight: 1, fare: 5, energy: 1, trip: [2, 6], patience: 2, rarity: 8, sheet: '02', cell: 0, tone: 'risk', short: '未控制 +4 金币/层 · 每层 +1 躁动', detail: '短期高风险收益：未受控制时每层赚4金币并增加1躁动。相邻警察或律师后每层赚1金币且不再制造躁动，抵达再奖励5金币。', risk: { label: '风险交易', guide: '警察 / 律师邻座可控' } },
  cop: { kind: 'cop', name: '警察', title: 'The Officer', weight: 2, fare: 8, energy: 1, trip: [3, 7], patience: 4, rarity: 8, sheet: '02', cell: 1, tone: 'support', short: '控制小偷，锁住炸弹倒计时', detail: '同时控制所有相邻小偷。与任意数量的炸弹客相邻期间，分别锁住他们的倒计时。' },
  ...
  drunk: { kind: 'drunk', name: '醉汉', title: 'The Drifter', weight: 2, fare: 14, energy: 1, trip: [2, 6], patience: 1, rarity: 7, sheet: '02', cell: 3, tone: 'risk', short: '未安抚：每层躁动 +1', detail: '高额底价补偿风险。被音乐家或护士安抚时不再制造躁动，并且每层再赚1金币；否则每层增加1躁动。', risk: { label: '风险交易', guide: '音乐家 / 护士邻座可安抚' } },
  nurse: { kind: 'nurse', name: '护士', title: 'The Nurse', weight: 1, fare: 8, energy: 1, trip: [3, 7], patience: 4, rarity: 8, sheet: '02', cell: 4, tone: 'support', short: '所有相邻乘客：每层各抵消1躁动', detail: '稳定的轻量照护：所有相邻乘客每层各抵消1点躁动，且自身每层只耗1电。也能阻止相邻醉汉与儿童的负面效果；多位护士可逐人叠加。' },
  ...
  ghost: { kind: 'ghost', name: '幽灵', title: 'The Apparition', weight: 0, fare: 8, energy: 0, trip: [4, 9], patience: 5, rarity: 6, sheet: '03', cell: 0, tone: 'occult', short: '不耗电，但会延误邻座', detail: '相邻驱魔师时，不再延误邻座，每位受控幽灵每层抵消2点人物耗电且到站多得6金币；否则到3的倍数层时随机延误一位邻座1站。所有节能逐项相加，但电梯运转仍至少耗1电。' },
  exorcist: { kind: 'exorcist', name: '驱魔师', title: 'The Warden', weight: 1, fare: 9, energy: 1, trip: [3, 7], patience: 3, rarity: 6, sheet: '03', cell: 1, tone: 'occult', short: '每位受控幽灵每站节能2电', detail: '控制每位相邻幽灵，分别阻止延误并使其每层抵消2点人物耗电、到站多得6金币。多位幽灵的效果逐个叠加；电梯运转仍至少耗1电。' },
  coach: { kind: 'coach', name: '教练', title: 'The Coach', weight: 3, fare: 20, energy: 1, trip: [3, 6], patience: 3, rarity: 6, sheet: '03', cell: 2, tone: 'social', short: '每位邻座教练使车费+50%', detail: '长线收益核心。非教练乘客抵达时，每位相邻教练都让其基础车费提高50%，线性叠加，小费不参与倍率；教练自己抵达时，每名仍在身旁的邻座额外支付3金币。' },
  celebrity: { kind: 'celebrity', name: '名人', title: 'The Celebrity', weight: 1, fare: 18, energy: 1, trip: [4, 8], patience: 2, rarity: 5, sheet: '03', cell: 3, tone: 'risk', short: '恰好 1 邻座 +3 金币/层 · 2+ 邻座每层+1躁动', detail: '恰好一名邻座时每层赚3金币；两名以上邻座时每层增加1躁动。', risk: { label: '条件风险', guide: '保持恰好 1 名邻座' } },
  inspector: { kind: 'inspector', name: '检查员', title: 'The Inspector', weight: 2, fare: 12, energy: 1, trip: [4, 8], patience: 4, rarity: 5, sheet: '03', cell: 4, tone: 'risk', short: '总耗电≤4则+1币；超过则每层+1躁动', detail: '每层检查整趟耗电：运转＋所有人物耗电−节能，总计不超过4电时奖励1金币，否则躁动+1。检查员本人也耗1电；稳压和节能能帮助通过检查。', risk: { label: '条件风险', guide: '总耗电尽量不超过4' } },
  bomb: { kind: 'bomb', name: '炸弹客', title: 'Bomb Timer', weight: 1, fare: 26, energy: 1, trip: [2, 6], patience: 1, rarity: 4, sheet: '03', cell: 5, tone: 'risk', short: '炸弹倒计时归零：本局立即失败', detail: '高额悬赏补偿整局失败风险。上车时获得3–6层倒计时；每上升一层减1，到站前归零会结束本局。与警察相邻期间，倒计时锁定不减。', risk: { label: '致命风险', guide: '与警察相邻：锁住倒计时' } },
...
export const UPGRADES: Record<UpgradeKey, { name: string; label: string; description: string; strategy: string; tone: 'sustain' | 'control' | 'score' | 'capacity' | 'tempo' }> = {
  battery: { name: '默契契约', label: 'COOPERATION', description: '每级使每条协作连接的到站奖励再 +2 金币。多条连接与多级升级都逐项叠加。', strategy: '协作收益', tone: 'score' },
  ...
  calm: { name: '舒缓系统', label: 'CALM SYSTEM', description: '躁动上限 +1，并立即降低 2 躁动。', strategy: '控场缓冲', tone: 'control' },
