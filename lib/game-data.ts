...
export const PASSENGERS: Record<PassengerKind, PassengerSpec> = {
  ...
  thief: { kind: 'thief', name: '小偷', title: 'The Thief', weight: 1, fare: 5, energy: 1, trip: [2, 6], patience: 2, rarity: 8, sheet: '02', cell: 0, tone: 'risk', short: "每层偷每位邻座2币、+1躁动；警察相邻可控", detail: "未受警察或律师控制时，每层从每位相邻乘客身上偷2金币（警察、律师、教父和传奇人物除外），并增加1躁动；挨着纸箱时不躁动，下车时带走纸箱，给一半箱内金币作小费。受控后不偷、不加躁动，到站额外+5金币。与未受控的小偷、醉汉或炸弹客相邻时，双方每层各暂存2金币，高躁动时各存3金币；多邻座不重复，每条链接额外+1躁动；暂存收益只有送达才支付，不参与倍率。", risk: { label: '风险交易', guide: '警察邻座可控' } },
  ...
  bomb: { kind: 'bomb', name: '炸弹客', title: 'Bomb Timer', weight: 1, fare: 14, energy: 1, trip: [2, 6], patience: 1, rarity: 4, sheet: '03', cell: 5, tone: 'risk', short: "倒计时归零前送达；坏人链接可暂存收益", detail: "基价以卡面为准，倒计时3–6层；到站前归零立即失败，同层归零安全。相邻警察锁住倒计时，也停止坏人链接。未受控时可与小偷、醉汉或炸弹客链接暂存收益。空手的快递员挨着时会接过炸弹：快递员先下车就带走炸弹，炸弹客变成乔装的通勤者（车费不变，没有倒计时）。", risk: { label: '致命风险', guide: '与警察相邻：锁住倒计时' } },
  ...
  parcel: { kind:'parcel', name:'纸箱', title:'The Parcel', weight:0, fare:0, energy:1, trip:[1,1], patience:9, rarity:0, sheet:'04', cell:0, tone:'support', short:'占座耗电；挨着快递员送达，无主时到站开箱', detail:'快递员的包裹，分普通、稀有、传奇；大纸箱占同一列上下两格。每格每层耗1电，不算任何人的邻座，本身不付钱。和它的快递员一起上车时必须挨着他；它的快递员没上车时，挨着另一位空手快递员也算他的。无主纸箱到站开箱，随机给金币或一半数量的电：普通6、稀有12、传奇24，大纸箱16、30、60。小偷挨着会在下车时带走它，给一半金币作小费；小孩挨着会在下一层拆开；维修工会拆无主纸箱当零件，立刻完成检修；检查员验快递员的箱子，快递员晚一层到站、多付5金币；复制人在它正下方会复制一个同样的箱子。' },
