...
export const PASSENGERS: Record<PassengerKind, PassengerSpec> = {
  ...
  lover: { kind: 'lover', name: '恋人', title: 'The Lover', weight: 1, fare: 6, energy: 1, trip: [3, 7], patience: 4, rarity: 10, sheet: '01', cell: 4, tone: 'social', short: '独处会呼唤同伴 · 配对后持续增收', detail: '独处时，每层有25%概率让下一批候选出现另一位恋人。两位恋人相邻后，每层合计获得2金币，且各自到站车费翻倍。' },
