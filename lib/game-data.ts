...
export const PASSENGERS: Record<PassengerKind, PassengerSpec> = {
  ...
  lawyer: { kind: 'lawyer', name: '律师', title: 'The Counsel', weight: 1, fare: 4, energy: 1, trip: [3, 7], patience: 4, rarity: 6, sheet: '02', cell: 2, tone: 'support', short: "控制小偷；每层抵消最多2金币红线损失", detail: "控制相邻小偷，不再产生偷窃躁动，到站额外+5。本人在车内时，整车每层抵消最多2金币红线损失；多位律师不叠加。不能暂停炸弹。" },
  ...
  ghost: { kind: 'ghost', name: '幽灵', title: 'The Apparition', weight: 0, fare: 1, energy: 0, trip: [5, 10], patience: 5, rarity: 6, sheet: '03', cell: 0, tone: 'occult', short: '0耗电；未受控到3的倍数层，随机1位邻座延误1站', detail: '相邻驱魔师时，不再延误邻座，每位受控幽灵每层抵消1点人物耗电且到站多得2金币；否则到3的倍数层时随机延误一位邻座1站。受控幽灵的节能逐项相加，但不能抵消电梯运转耗电。' },
  ...
  exlover: { kind:'exlover', name:'怨偶', title:'The Ex', weight:1, fare:6, energy:1, trip:[3,7], patience:4, rarity:0, sheet:'01', cell:0, tone:'social', short:'两位怨偶相邻就吵（红线）；分开坐：基价×2', detail:'暗黑版恋人。两位怨偶相邻是红线（吵架，+1 躁动）。另一位怨偶也在车上但不相邻时，到站基价 ×2。单独一人时会把前任叫来。挨着普通恋人会搅局（红线）。' },
  ...
  crookedcop: { kind:'crookedcop', name:'黑警', title:'The Crooked Cop', weight:2, fare:5, energy:1, trip:[3,6], patience:4, rarity:0, sheet:'02', cell:0, tone:'support', short:'管住身边所有坏人，全车每层−1躁动；每层收你3币保护费', detail:'暗黑版警察。身边的小偷、劫匪、醉汉、狂徒都被管住，炸弹客和疯炸客的倒计时也被锁住；在车上时全车每层 −1 躁动。代价是每层从你钱包收 3 金币保护费。和偷拍客、讼棍是红线。' },
