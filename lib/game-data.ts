...
export const PASSENGERS: Record<PassengerKind, PassengerSpec> = {
  ...
  lover: { kind: 'lover', name: '恋人', title: 'The Lover', weight: 1, fare: 5, energy: 1, trip: [3, 7], patience: 4, rarity: 10, sheet: '01', cell: 4, tone: 'social', short: "每位邻座恋人：到站基价+100%", detail: "有未配对恋人时，每层全车统一15%概率呼唤1位恋人，不按人数叠加。成功时另两位为非恋人，仍可互相作用；未触发时按普通候客规则生成。每位相邻恋人让本人到站基价增加100%，线性叠加；途中不产金币。小费、默契和高危加价不参与倍率。" },
  ...
  nightingale: { kind:'nightingale', name:'夜莺', title:'The Nightingale', weight:0, fare:0, energy:0, trip:[9,9], patience:9, rarity:0, sheet:'04', cell:0, tone:'social', short:'传奇 · 中躁动每层+7币', detail:'爵士歌手。第1层上车、第10层下车，不耗电、不付车费。关门时中躁动每层+7金币；低躁动时每层+1躁动。相邻游客多算1位邻座。信物「黑胶唱片」：音乐家从第1层起出现，中躁动时音乐家演出收入再+2、每位到站乘客小费再+2。' },
