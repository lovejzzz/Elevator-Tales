...
export const PASSENGERS: Record<PassengerKind, PassengerSpec> = {
  ...
  lover: { kind: 'lover', name: '恋人', title: 'The Lover', weight: 1, fare: 3, energy: 1, trip: [3, 7], patience: 4, rarity: 10, sheet: '01', cell: 4, tone: 'social', short: "每位邻座恋人：到站基价+100%", detail: "独处时每层有25%概率呼唤恋人。每位相邻恋人让本人到站基价增加100%，线性叠加；途中不产金币。小费、默契和高危加价不参与倍率。" },
  ...
  drunk: { kind: 'drunk', name: '醉汉', title: 'The Drifter', weight: 2, fare: 10, energy: 1, trip: [2, 6], patience: 1, rarity: 7, sheet: '02', cell: 3, tone: 'risk', short: '高躁动到站：基价+100%', detail: '未受护士照护时每层+1躁动。到站前关门时处于高躁动，基价额外+100%，无需额外邻座，不消耗躁动；与教练倍率相加。护士可停止新增躁动，不降低全局已有躁动，但会停止醉汉的坏人链接。', risk: { label: '风险交易', guide: '护士邻座可安抚；音乐家调节全舱' } },
  ...
  ghost: { kind: 'ghost', name: '幽灵', title: 'The Apparition', weight: 0, fare: 4, energy: 0, trip: [4, 9], patience: 5, rarity: 6, sheet: '03', cell: 0, tone: 'occult', short: '不耗电，但会延误邻座', detail: '相邻驱魔师时，不再延误邻座，每位受控幽灵每层抵消1点人物耗电且到站多得2金币；否则到3的倍数层时随机延误一位邻座1站。受控幽灵的节能逐项相加，但不能抵消电梯运转耗电。' },
  ...
  bomb: { kind: 'bomb', name: '炸弹客', title: 'Bomb Timer', weight: 1, fare: 14, energy: 1, trip: [2, 6], patience: 1, rarity: 4, sheet: '03', cell: 5, tone: 'risk', short: "倒计时归零前送达；坏人链接可暂存收益", detail: "基价14，倒计时3–6层；到站前归零立即失败，同层归零安全。相邻警察锁住倒计时，也停止坏人链接。未受控时可与小偷、醉汉或炸弹客链接暂存收益。", risk: { label: '致命风险', guide: '与警察相邻：锁住倒计时' } },
