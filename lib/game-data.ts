...
export const PASSENGERS: Record<PassengerKind, PassengerSpec> = {
  ...
  lover: { kind: 'lover', name: '情侣', title: 'The Lover', weight: 1, fare: 6, energy: 1, trip: [3, 7], patience: 2, rarity: 10, sheet: '01', cell: 4, tone: 'social', short: '需要另一名情侣相邻', detail: '相邻情侣时每层获得1金币，抵达车费翻倍；分开时每两层额外失去1耐心。' },
