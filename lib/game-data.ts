...
export const PASSENGERS: Record<PassengerKind, PassengerSpec> = {
  ...
  tourist: { kind: 'tourist', name: '游客', title: 'The Tourist', weight: 2, fare: 18, energy: 1, trip: [4, 7], patience: 3, rarity: 10, sheet: '01', cell: 1, tone: 'steady', short: '每种不同职业邻座：每站+1币，最多+2', detail: '基础车费18。每种不同职业的相邻乘客，让游客每层多赚1金币，最多+2。相邻游客不计，同职业不重复；邻座变化时立即重新计算。' },
  courier: { kind: 'courier', name: '快递员', title: 'The Courier', weight: 1, fare: 6, energy: 1, trip: [1, 3], patience: 2, rarity: 9, sheet: '01', cell: 2, tone: 'support', short: '到站补充1电 · 短途周转', detail: '目的地很近；到站时为电梯补充1电（不超过电量上限），适合用短途周转换取续航。' },
  ...
  thief: { kind: 'thief', name: '小偷', title: 'The Thief', weight: 1, fare: 5, energy: 1, trip: [3, 7], patience: 2, rarity: 8, sheet: '02', cell: 0, tone: 'risk', short: '未控制 +3 金币/层 · 每层 +1 躁动', detail: '未受控制时每层赚3金币并增加1躁动。相邻警察或律师后每层赚1金币且不再制造躁动，抵达再奖励5金币。', risk: { label: '风险交易', guide: '警察 / 律师邻座可控' } },
  ...
  bomb: { kind: 'bomb', name: '炸弹客', title: 'Bomb Timer', weight: 1, fare: 26, energy: 1, trip: [2, 6], patience: 1, rarity: 4, sheet: '03', cell: 5, tone: 'risk', short: '炸弹倒计时归零：本局立即失败', detail: '高额悬赏补偿整局失败风险。上车时获得3–6层倒计时；每上升一层减1，到站前归零会结束本局。与警察相邻时，偶数层暂停倒计时。', risk: { label: '致命风险', guide: '与警察相邻：偶数层倒计时不减' } },
