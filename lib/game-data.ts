...
export const PASSENGERS: Record<PassengerKind, PassengerSpec> = {
  ...
  musician: { kind: 'musician', name: '音乐家', title: 'The Musician', weight: 1, fare: 8, energy: 1, trip: [4, 8], patience: 3, rarity: 7, sheet: '01', cell: 5, tone: 'social', short: '抵消一名相邻乘客的1躁动', detail: '每层抵消一名相邻乘客的1点躁动；多位音乐家可逐个叠加，但不会把躁动降成负数。也能阻止相邻醉汉与儿童的负面效果。' },
  thief: { kind: 'thief', name: '小偷', title: 'The Thief', weight: 1, fare: 5, energy: 1, trip: [3, 7], patience: 2, rarity: 8, sheet: '02', cell: 0, tone: 'risk', short: '未控制 +4 金币/层 · 每层 +1 躁动', detail: '未受控制时每层赚4金币并增加1躁动。相邻警察或律师后每层赚1金币且不再制造躁动，抵达再奖励5金币。', risk: { label: '风险交易', guide: '警察 / 律师邻座可控' } },
  ...
  nurse: { kind: 'nurse', name: '护士', title: 'The Nurse', weight: 2, fare: 9, energy: 1, trip: [3, 7], patience: 4, rarity: 7, sheet: '02', cell: 4, tone: 'support', short: '抵消一名相邻乘客的1躁动', detail: '每层抵消一名相邻乘客的1点躁动；多位护士可逐个叠加，但不会把躁动降成负数。也能阻止相邻醉汉与儿童的负面效果。' },
  ...
  coach: { kind: 'coach', name: '教练', title: 'The Coach', weight: 3, fare: 20, energy: 2, trip: [3, 6], patience: 3, rarity: 6, sheet: '03', cell: 2, tone: 'social', short: '每位邻座教练使车费+50%', detail: '非教练乘客抵达时，每位相邻教练都让其基础车费提高50%，线性叠加，小费不参与倍率；教练自己抵达时，每名仍在身旁的邻座额外支付3金币。' },
