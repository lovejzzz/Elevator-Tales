...
export const PASSENGERS: Record<PassengerKind, PassengerSpec> = {
  ...
  lover: { kind: 'lover', name: '恋人', title: 'The Lover', weight: 1, fare: 6, energy: 1, trip: [3, 7], patience: 4, rarity: 10, sheet: '01', cell: 4, tone: 'social', short: '成对合计 +2金币/层、车费×2 · 独处偶数层 −1耐心', detail: '与另一位恋人相邻后，两人每层合计获得2金币，且各自到站车费翻倍；独处时每逢偶数层额外失去1耐心。' },
