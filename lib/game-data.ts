...
export const PASSENGERS: Record<PassengerKind, PassengerSpec> = {
  commuter: { kind: 'commuter', name: '通勤者', title: 'The Commuter', weight: 1, fare: 4, energy: 1, trip: [2, 5], patience: 3, rarity: 18, sheet: '01', cell: 0, tone: 'steady', short: '低躁动到站：额外+3金币', detail: '到站前关门时处于低躁动，额外支付3金币，不参与倍率。不消耗躁动，也不要求邻座。' },
  tourist: { kind: 'tourist', name: '游客', title: 'The Tourist', weight: 2, fare: 5, energy: 1, trip: [4, 7], patience: 3, rarity: 10, sheet: '01', cell: 1, tone: 'steady', short: "本人到站：每位邻座+2币；本次关门时中躁动再+3", detail: "基价以卡面为准；每位仍相邻的乘客让本人到站多赚2金币，包括游客与同层到站者。到站前关门时处于中躁动，再支付3金币；两项均不参与倍率。途中不产金币。" },
  courier: { kind: 'courier', name: '快递员', title: 'The Courier', weight: 1, fare: 5, energy: 1, trip: [1, 3], patience: 2, rarity: 4, sheet: '01', cell: 2, tone: 'support', short: '送包裹：纸箱在旁才付钱 · 回 2 电', detail: '会多带一张纸箱卡：普通、稀有或传奇，偶尔是占上下两格的大纸箱，他的卡和箱子同一稀有度。纸箱挨着他（上下左右）时，他到站付车费并为电梯补充2电，箱子越稀有付得越多；箱子越好送得越远：普通1–4站，稀有2–5站，传奇3–6站，大纸箱再多1站，路程超过2站的部分每站多付3金币；没有纸箱时每层+1躁动，到站不付钱也不补电。另一位空手快递员也挨着他的箱子时，两人都+1躁动，他照常付钱。空手时挨着炸弹客会接过炸弹：比炸弹客先下车就带走炸弹、照常付钱，炸弹客变成乔装的通勤者。' },
  mechanic: { kind: 'mechanic', name: '维修工', title: 'The Mechanic', weight: 2, fare: 4, energy: 1, trip: [3, 7], patience: 3, rarity: 5, sheet: '01', cell: 3, tone: 'support', short: '低躁动检修2次：随后4层运转少耗1电', detail: '关门时处于低躁动，检修进度+1；其他状态暂停，不清空进度。完成2次后，随后4次上行运转少耗1电；每位维修工仅完成一次。多位延长时间，最多8层，不增加每层节能量。不消耗躁动。挨着无主纸箱时会拆来当零件：纸箱没了，检修立刻完成。' },
  lover: { kind: 'lover', name: '恋人', title: 'The Lover', weight: 1, fare: 3, energy: 1, trip: [3, 7], patience: 4, rarity: 10, sheet: '01', cell: 4, tone: 'social', short: "每位邻座恋人：到站基价+100%", detail: "有未配对恋人时，每层全车统一15%概率呼唤1位恋人，不按人数叠加。成功时另两位为非恋人，仍可互相作用；未触发时按普通候客规则生成。每位相邻恋人让本人到站基价增加100%，线性叠加；途中不产金币。小费、默契和急躁加价不参与倍率。" },
  musician: { kind: 'musician', name: '音乐家', title: 'The Musician', weight: 2, fare: 5, energy: 2, trip: [2, 5], patience: 3, rarity: 5, sheet: '01', cell: 5, tone: 'social', short: '全舱节拍：向中躁动靠近；中躁动每层+2币', detail: '按关门时状态：低躁动向3提高最多2点，高躁动向4降低最多2点，中躁动不变；关门时处于中躁动，每层演出收入+2金币。多位音乐家不叠加。不单独照护邻座，也不停止坏人合作。节拍后仍会结算人物、红线与到站舒缓；不是保证最终停在中档。' },
  thief: { kind: 'thief', name: '小偷', title: 'The Thief', weight: 1, fare: 3, energy: 1, trip: [2, 6], patience: 2, rarity: 8, sheet: '02', cell: 0, tone: 'risk', short: "每层偷邻座的钱、+1躁动；被警察管住后帮忙降躁动", detail: "未受警察或律师控制时，每层从每位相邻乘客身上偷钱，口袋越鼓偷得越多：名人4，游客、神秘人、百变人3，大多数人2，维修工、护士、儿童、醉汉、驱魔师、检查员、小偷1，幽灵偷不到（警察、律师、教父和传奇人物除外），并增加1躁动；挨着纸箱时不躁动，下车时带走纸箱，给一半箱内金币作小费。受控后不再偷钱，改为每层帮全车−1躁动，到站额外+5金币。与未受控的小偷、醉汉或炸弹客相邻时，双方每层各暂存2金币，高躁动时各存3金币；多邻座不重复，每条链接额外+1躁动；暂存收益只有送达才支付，不参与倍率。", risk: { label: '风险交易', guide: '警察邻座可控' } },
  cop: { kind: 'cop', name: '警察', title: 'The Officer', weight: 2, fare: 4, energy: 1, trip: [3, 7], patience: 4, rarity: 8, sheet: '02', cell: 1, tone: 'support', short: '控制小偷，锁住炸弹倒计时', detail: '同时控制所有相邻小偷。与任意数量的炸弹客相邻期间，分别锁住他们的倒计时。' },
  lawyer: { kind: 'lawyer', name: '律师', title: 'The Counsel', weight: 1, fare: 4, energy: 1, trip: [3, 7], patience: 4, rarity: 6, sheet: '02', cell: 2, tone: 'support', short: "控制小偷（和警察一样）", detail: "控制相邻小偷，不再产生偷窃躁动，到站额外+5。不能暂停炸弹。" },
  drunk: { kind: 'drunk', name: '醉汉', title: 'The Drifter', weight: 2, fare: 6, energy: 1, trip: [2, 6], patience: 1, rarity: 7, sheet: '02', cell: 3, tone: 'risk', short: '到站前关门时高躁动：基价+100%', detail: '未受护士照护时每层+1躁动。到站前关门时处于高躁动，基价额外+100%，无需额外邻座，不消耗躁动；与教练倍率相加。护士可停止新增躁动，不降低全局已有躁动，但会停止醉汉的坏人链接。', risk: { label: '风险交易', guide: '护士邻座可安抚；音乐家调节全舱' } },
  nurse: { kind: 'nurse', name: '护士', title: 'The Nurse', weight: 1, fare: 3, energy: 1, trip: [3, 7], patience: 4, rarity: 8, sheet: '02', cell: 4, tone: 'support', short: '所有相邻乘客：每层各抵消1躁动', detail: '稳定的轻量照护：所有相邻乘客自身带来的躁动每层各抵消1点（夜深人躁等整车来源不算），且自身每层只耗1电。也能阻止相邻醉汉与儿童的负面效果；多位护士可逐人叠加。' },
  child: { kind: 'child', name: '儿童', title: 'The Child', weight: 1, fare: 4, energy: 1, trip: [2, 5], patience: 1, rarity: 7, sheet: '02', cell: 5, tone: 'social', short: '照顾满2层：到站额外+6币', detail: '没有恋人或护士相邻时，每层躁动+1；有照顾者时免除并积累1次照护。累计2次后，到站额外+6金币，不参与倍率；无人照护时进度保留，不重复完成。挨着纸箱时不躁动，并在下一层把纸箱拆开：箱里的金币或电归你，它的快递员就没箱子了。' },
  ghost: { kind: 'ghost', name: '幽灵', title: 'The Apparition', weight: 0, fare: 1, energy: 0, trip: [5, 10], patience: 5, rarity: 6, sheet: '03', cell: 0, tone: 'occult', short: '车费按路程：每坐一层 1 币 · 0 耗电 · 没人管：+1 躁动/层、每 3 层延误一位邻座', detail: '不耗电，车费按路程算：每坐一层 1 金币（路程 5–10 层）。相邻驱魔师、召魂人或灵媒时受控：不作祟、不延误邻座，每层抵消 1 点人物耗电，到站再多 2 金币。没人管时每层 +1 躁动，到 3 的倍数层随机延误一位邻座 1 站。' },
  exorcist: { kind: 'exorcist', name: '驱魔师', title: 'The Warden', weight: 1, fare: 3, energy: 1, trip: [3, 7], patience: 3, rarity: 6, sheet: '03', cell: 1, tone: 'occult', short: '每位受控幽灵每层抵1人物耗电；不抵运转', detail: '控制每位相邻幽灵，分别阻止延误并使其每层抵消1点人物耗电、到站多得2金币。多位幽灵的效果逐个叠加；电梯运转耗电不能被抵消。' },
  coach: { kind: 'coach', name: '教练', title: 'The Coach', weight: 3, fare: 6, energy: 2, trip: [3, 6], patience: 3, rarity: 6, sheet: '03', cell: 2, tone: 'social', short: '每位邻座教练使车费+50%', detail: '非教练乘客抵达时，每位相邻教练增加其本体基价的50%；与恋人配对、醉汉加价等倍率相加，不再放大受控奖励、小费或状态奖励。教练自己抵达时，每位仍在身旁的邻座额外支付3金币。' },
  celebrity: { kind: 'celebrity', name: '名人', title: 'The Celebrity', weight: 1, fare: 11, energy: 2, trip: [4, 8], patience: 2, rarity: 5, sheet: '03', cell: 3, tone: 'risk', short: "恰好1邻座每层+2币；2+邻座+1躁动", detail: "恰好一位邻座时每层赚2金币；至少两位邻座时每层+1躁动。无人相邻无效果。", risk: { label: '条件风险', guide: '保持恰好 1 名邻座' } },
  inspector: { kind: 'inspector', name: '检查员', title: 'The Inspector', weight: 2, fare: 5, energy: 1, trip: [4, 7], patience: 4, rarity: 5, sheet: '03', cell: 4, tone: 'support', short: '连续3层不在高躁动：到站额外+12币', detail: '连续3次关门时不在高躁动（低或中躁动都算），获得合规印章，到站额外+12金币，不参与倍率。完成前遇到高躁动会重新计数；完成后印章保留，每位检查员只奖励一次。检查员本人不会带躁动。挨着快递员的纸箱时会验货一次：快递员晚一层到站，送达多付5金币。' },
  bomb: { kind: 'bomb', name: '炸弹客', title: 'Bomb Timer', weight: 1, fare: 16, energy: 2, trip: [2, 6], patience: 1, rarity: 4, sheet: '03', cell: 5, tone: 'risk', short: "实时倒计时：归零前送达；归零会炸飞邻座、损失金币", detail: "基价以卡面为准，车费很高。上车后开始实时倒计时：10秒加每站10秒，高躁动时两倍速；到站前归零会爆炸：他和身边的乘客（传说人物除外）被炸下车，都不付车费，你损失 20 金币；本班继续。切到别的页面、进商店或打开菜单时暂停，看人物卡时不暂停。相邻警察锁住倒计时，也停止坏人链接。送达时每剩3秒多付1金币拆弹奖金；警察锁住时倒计时停住，但拆弹奖金照样随时间减少。未受控时可与小偷、醉汉或炸弹客链接暂存收益。空手的快递员挨着时会接过炸弹：快递员先下车就带走炸弹，炸弹客变成乔装的通勤者（车费不变，没有倒计时）。", risk: { label: '条件风险', guide: '与警察相邻：锁住倒计时' } },
  ...
  overtimer: { kind:'overtimer', name:'加班魂', title:'The Overtimer', weight:1, fare:6, energy:2, trip:[2,5], patience:3, rarity:0, sheet:'01', cell:0, tone:'steady', short:'每坐一层加班费+2币；到站要等邻座一起下，赖着不走每层+1躁动', detail:'暗黑版通勤者。每乘坐一层，加班费 +2 金币，到站一起结算。到了目的地不会自己下车：要等同一层有邻座下车时才跟着下；赖着不走的每一层 +1 躁动；过站 3 层后不付钱自己离开。闹钟可以让他准时下车。' },
  voyeur: { kind:'voyeur', name:'偷拍客', title:'The Voyeur', weight:1, fare:7, energy:1, trip:[3,6], patience:3, rarity:0, sheet:'01', cell:0, tone:'risk', short:'每层偷拍普通邻座：+1躁动；到站每张照片+3币', detail:'暗黑版游客。只要身边有普通乘客（不是暗黑版），每层偷拍一张：车厢 +1 躁动，照片到站时每张 +3 金币。身边只有暗黑版或空位时安静。和丑闻明星是绿线。' },
  smuggler: { kind:'smuggler', name:'走私客', title:'The Smuggler', weight:1, fare:5, energy:1, trip:[1,4], patience:2, rarity:0, sheet:'01', cell:0, tone:'risk', short:'带黑箱：黑箱在旁才付钱，箱价×2；普通检查员会没收，贪腐检查员放行', detail:'暗黑版快递员，带着一个黑箱。黑箱挨着他送达时，他付车费加两倍箱价；没带黑箱不付钱。普通检查员挨着黑箱会没收它（你得 15 金币举报奖励，走私客从此没箱子）；贪腐检查员挨着黑箱则放行，送达时再 +8 金币。' },
  scrapper: { kind:'scrapper', name:'拆机人', title:'The Scrapper', weight:1, fare:4, energy:1, trip:[3,6], patience:3, rarity:0, sheet:'01', cell:0, tone:'support', short:'每层拆零件卖+4币，电梯运转多耗1电', detail:'暗黑版维修工。每层从电梯上拆零件卖钱：+4 金币，但电梯运转多耗 1 电。挨着贪腐检查员时销赃每层再 +2。电量宽裕时用电换钱。' },
  exlover: { kind:'exlover', name:'怨偶', title:'The Ex', weight:1, fare:6, energy:1, trip:[3,7], patience:4, rarity:0, sheet:'01', cell:0, tone:'social', short:'两位怨偶相邻就吵（各 +1 躁动）；分开坐：基价×2', detail:'暗黑版恋人。两位怨偶相邻会吵架，各 +1 躁动/层（虽然符号相同）。另一位怨偶也在车上但不相邻时，到站基价 ×2。单独一人时会把前任叫来。和普通恋人的符号相反，挨着是红线。' },
  noisemaker: { kind:'noisemaker', name:'噪音乐手', title:'The Noisemaker', weight:2, fare:7, energy:2, trip:[2,5], patience:3, rarity:0, sheet:'01', cell:0, tone:'social', short:'每层躁动+1（已高躁动时不加）；高躁动时每层+4币', detail:'暗黑版音乐家。把躁动往高处拉：不在高躁动时每层 +1 躁动；关门时处于高躁动，每层 +4 金币。他下车时躁动额外 −2。和狂徒是绿线。' },
  robber: { kind:'robber', name:'劫匪', title:'The Robber', weight:1, fare:14, energy:1, trip:[2,5], patience:2, rarity:0, sheet:'02', cell:0, tone:'risk', short:'没人管：每层抢你2币+3%（最多10）、+1躁动；被管住：到站赏金+15', detail:'暗黑版小偷。不偷乘客，直接抢你的钱包：没人管时每层拿走 2 金币加你余额的 3%（最多 10），并 +1 躁动。警察、黑警或便衣警察挨着他就管住了，到站时再付 15 金币赏金。讼棍挨着他时，警察管不住他。手铐也能管住他。' },
  crookedcop: { kind:'crookedcop', name:'黑警', title:'The Crooked Cop', weight:2, fare:5, energy:1, trip:[3,6], patience:4, rarity:0, sheet:'02', cell:0, tone:'support', short:'管住身边所有坏人，全车每层−1躁动；每层收你3币保护费', detail:'暗黑版警察。身边的小偷、劫匪、醉汉、狂徒都被管住，炸弹客和疯炸客的倒计时也被锁住；在车上时全车每层 −1 躁动。代价是每层从你钱包收 3 金币保护费。' },
  shyster: { kind:'shyster', name:'讼棍', title:'The Shyster', weight:1, fare:7, energy:1, trip:[3,6], patience:4, rarity:0, sheet:'02', cell:0, tone:'support', short:'车上每条红线每层+3币（最多9）', detail:'暗黑版律师。车上每有一条红线，他就每层帮你打官司赚 3 金币（最多 9）。挨着劫匪时，警察管不住那个劫匪。' },
  brawler: { kind:'brawler', name:'狂徒', title:'The Brawler', weight:2, fare:10, energy:2, trip:[2,5], patience:1, rarity:0, sheet:'02', cell:0, tone:'risk', short:'自己+1躁动，每位普通邻座再+1；高躁动到站车费×3', detail:'暗黑版醉汉。每层自己 +1 躁动，每位普通邻座（不是暗黑版）再 +1。关门时处于高躁动，到站基价 ×3。护士或药贩挨着能压住一部分；黑警能管住他。他下车时躁动额外 −2。和噪音乐手是绿线。' },
  pusher: { kind:'pusher', name:'药贩', title:'The Pusher', weight:1, fare:4, energy:1, trip:[3,6], patience:4, rarity:0, sheet:'02', cell:0, tone:'support', short:'每位邻座自身躁动每层−2；她下车后，身边的人戒断2层（每层+1）', detail:'暗黑版护士。每位邻座自身带来的躁动每层抵消 2 点。她下车时，当时挨着她的人开始戒断：接下来 2 层每人每层 +1 躁动。让她和吃药的人同站下车，就没有戒断。' },
  ...
  taskmaster: { kind:'taskmaster', name:'监工', title:'The Taskmaster', weight:3, fare:12, energy:2, trip:[3,6], patience:3, rarity:0, sheet:'03', cell:0, tone:'social', short:'邻座车费+100%，普通邻座每层各+1躁动', detail:'暗黑版教练。每位邻座到站基价 +100%（教练是 +50%），但每位普通邻座（不是暗黑版）每层 +1 躁动。' },
  ...
  madbomber: { kind:'madbomber', name:'疯炸客', title:'The Mad Bomber', weight:1, fare:52, energy:3, trip:[3,5], patience:1, rarity:0, sheet:'03', cell:0, tone:'risk', short:'弗兰肯斯坦炸弹：倒计时更短，普通警察锁不住；归零时本班结束', detail:'暗黑版炸弹客，抱着一颗弗兰肯斯坦式的怪炸弹。实时倒计时比炸弹客短，普通警察锁不住，只有黑警挨着才能锁住，或用引线剪当场拆掉。归零时本班结束。车费 50。', risk: { label: '致命风险', guide: '与黑警相邻：锁住倒计时' } },
  ...
  mimic: { kind:'mimic', name:'复制人', title:'The Mimic', weight:1, fare:6, energy: 1, trip:[3,6], patience:4, rarity:6, sheet:'04', cell:2, tone:'occult', short:'↑ 复制正上方乘客的车费', detail:'固定复制正上方紧邻乘客的基础车费，按那位乘客实际的票价，不再打自己的短途折扣；上方空缺时恢复本体车费。隐藏车费仍隐藏。不复制技能、耗电、倒计时、路程或已叠加奖励。正上方是纸箱时，复制一个同样的箱子，下车时打开。'} ,
  ...
  matchmaker: { kind:'matchmaker', name:'月老', title:'The Matchmaker', weight:0, fare:0, energy:0, trip:[9,9], patience:9, rarity:0, sheet:'04', cell:0, tone:'social', short:'传奇 · 恋人呼唤50%；邻座到站+3币', detail:'第1层上车、第10层下车，不耗电、不付车费。在车时恋人呼唤概率升至50%，她的每位邻座到站额外+3金币；车内每有一条红线，每层额外+1躁动。信物「红绳」：热闹和江湖每级绿线每层 +2 金币，此后恋人呼唤概率35%。' },
...
export const UPGRADES: Record<UpgradeKey, { name: string; label: string; description: string; strategy: string; tone: 'sustain' | 'control' | 'score' | 'capacity' | 'tempo' }> = {
  ...
  insulation: { name: '绝缘衬层', label: 'INSULATION', description: '每条红线每层付 1 金币“冲突小费”（每层最多 3）；红线躁动仍然生效。', strategy: '容忍冲突', tone: 'sustain' },
