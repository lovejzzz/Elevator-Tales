...
export const PASSENGERS: Record<PassengerKind, PassengerSpec> = {
  ...
  voyeur: { kind:'voyeur', name:'偷拍客', title:'The Voyeur', weight:1, fare:9, energy:1, trip:[3,6], patience:3, rarity:0, sheet:'01', cell:0, tone:'risk', short:'每层偷拍普通邻座：+1躁动；到站每张照片+3币', detail:'暗黑版游客。只要身边有普通乘客（不是暗黑版），每层偷拍一张：车厢 +1 躁动，照片到站时每张 +3 金币。身边只有暗黑版或空位时安静。和丑闻明星是绿线。' },
  smuggler: { kind:'smuggler', name:'走私客', title:'The Smuggler', weight:1, fare:6, energy:1, trip:[1,4], patience:2, rarity:0, sheet:'01', cell:0, tone:'risk', short:'带黑箱：黑箱在旁才付钱，箱价×2；普通检查员会没收，贪腐检查员放行', detail:'暗黑版快递员，带着一个黑箱。黑箱挨着他送达时，他付车费加两倍箱价；没带黑箱不付钱。普通检查员挨着黑箱会没收它（你得 15 金币举报奖励，走私客从此没箱子）；贪腐检查员挨着黑箱则放行，送达时再 +8 金币。' },
  scrapper: { kind:'scrapper', name:'拆机人', title:'The Scrapper', weight:1, fare:5, energy:1, trip:[3,6], patience:3, rarity:0, sheet:'01', cell:0, tone:'support', short:'每层拆零件卖+4币，电梯运转多耗1电', detail:'暗黑版维修工。每层从电梯上拆零件卖钱：+4 金币，但电梯运转多耗 1 电。挨着贪腐检查员时销赃每层再 +2。电量宽裕时用电换钱。' },
  exlover: { kind:'exlover', name:'怨偶', title:'The Ex', weight:1, fare:7, energy:1, trip:[3,7], patience:4, rarity:0, sheet:'01', cell:0, tone:'social', short:'两位怨偶相邻就吵（红线）；分开坐：基价×2', detail:'暗黑版恋人。两位怨偶相邻是红线（吵架，+1 躁动）。另一位怨偶也在车上但不相邻时，到站基价 ×2。单独一人时会把前任叫来。挨着普通恋人会搅局（红线）。' },
  noisemaker: { kind:'noisemaker', name:'噪音乐手', title:'The Noisemaker', weight:2, fare:9, energy:2, trip:[2,5], patience:3, rarity:0, sheet:'01', cell:0, tone:'social', short:'每层躁动+1（已高躁动时不加）；高躁动时每层+4币', detail:'暗黑版音乐家。把躁动往高处拉：不在高躁动时每层 +1 躁动；关门时处于高躁动，每层 +4 金币。他下车时躁动额外 −2。和狂徒是绿线。' },
  ...
  crookedcop: { kind:'crookedcop', name:'黑警', title:'The Crooked Cop', weight:2, fare:6, energy:1, trip:[3,6], patience:4, rarity:0, sheet:'02', cell:0, tone:'support', short:'管住身边所有坏人，全车每层−1躁动；每层收你3币保护费', detail:'暗黑版警察。身边的小偷、劫匪、醉汉、狂徒都被管住，炸弹客和疯炸客的倒计时也被锁住；在车上时全车每层 −1 躁动。代价是每层从你钱包收 3 金币保护费。和偷拍客、讼棍是红线。' },
  shyster: { kind:'shyster', name:'讼棍', title:'The Shyster', weight:1, fare:9, energy:1, trip:[3,6], patience:4, rarity:0, sheet:'02', cell:0, tone:'support', short:'车上每条红线每层+3币（最多9）', detail:'暗黑版律师。车上每有一条红线，他就每层帮你打官司赚 3 金币（最多 9）。挨着劫匪时，警察管不住那个劫匪。' },
  ...
  pusher: { kind:'pusher', name:'药贩', title:'The Pusher', weight:1, fare:5, energy:1, trip:[3,6], patience:4, rarity:0, sheet:'02', cell:0, tone:'support', short:'每位邻座自身躁动每层−2；她下车后，身边的人戒断2层（每层+1）', detail:'暗黑版护士。每位邻座自身带来的躁动每层抵消 2 点。她下车时，当时挨着她的人开始戒断：接下来 2 层每人每层 +1 躁动。让她和吃药的人同站下车，就没有戒断。' },
  creepychild: { kind:'creepychild', name:'怪童', title:'The Uncanny Child', weight:1, fare:6, energy:1, trip:[2,5], patience:1, rarity:0, sheet:'02', cell:0, tone:'social', short:'每位普通邻座+1躁动；到站时一个邻座都没有+10币', detail:'暗黑版儿童。不要人照顾：身边每有一位普通乘客（不是暗黑版），每层 +1 躁动。到站时身边一个人都没有，额外 +10 金币。' },
  wraith: { kind:'wraith', name:'怨灵', title:'The Wraith', weight:0, fare:4, energy:0, trip:[4,8], patience:5, rarity:0, sheet:'03', cell:0, tone:'occult', short:'没人管：每层拖延一位邻座1站并吸1电；受控：每层+4币', detail:'暗黑版幽灵。没人管时，每层都随机拖延一位邻座 1 站，并吸走 1 电。驱魔师、召魂人或灵媒挨着它时受控：每层反而 +4 金币。' },
  summoner: { kind:'summoner', name:'召魂人', title:'The Summoner', weight:1, fare:5, energy:2, trip:[3,6], patience:3, rarity:0, sheet:'03', cell:0, tone:'occult', short:'管住幽灵与怨灵；每3层召一只幽灵进空座；身边受控幽灵车费×2', detail:'暗黑版驱魔师。管住身边的幽灵和怨灵。每到 3 的倍数层，把一只幽灵召进一个空座（幽灵自带车费，路程 4 站）。挨着他的受控幽灵到站车费 ×2。' },
  taskmaster: { kind:'taskmaster', name:'监工', title:'The Taskmaster', weight:3, fare:10, energy:2, trip:[3,6], patience:3, rarity:0, sheet:'03', cell:0, tone:'social', short:'邻座车费+100%，普通邻座每层各+1躁动', detail:'暗黑版教练。每位邻座到站基价 +100%（教练是 +50%），但每位普通邻座（不是暗黑版）每层 +1 躁动。' },
  scandal: { kind:'scandal', name:'丑闻明星', title:'The Scandal', weight:1, fare:20, energy:2, trip:[4,7], patience:2, rarity:0, sheet:'03', cell:0, tone:'risk', short:'每位邻座每层+1币；偷拍客在旁再+3；检查员或黑警在旁：到站曝光，车费归零', detail:'暗黑版名人。邻座越多越好：每位邻座每层 +1 金币；挨着偷拍客每层再 +3。到站时如果挨着检查员或黑警，丑闻曝光：这一趟的车费和暂存全部归零。' },
