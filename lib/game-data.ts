...
export const PASSENGERS: Record<PassengerKind, PassengerSpec> = {
  ...
  coach: { kind: 'coach', name: '教练', title: 'The Coach', weight: 3, fare: 7, energy: 2, trip: [3, 6], patience: 3, rarity: 6, sheet: '03', cell: 2, tone: 'social', short: '每位邻座教练使车费+50%', detail: '非教练乘客抵达时，每位相邻教练增加其本体基价的50%；与恋人配对、醉汉加价等倍率相加，不再放大受控奖励、小费或状态奖励。教练自己抵达时，每位仍在身旁的邻座额外支付2金币。' },
  ...
  highroller: { kind:'highroller', name:'赌王', title:'The High Roller', weight:0, fare:0, energy:0, trip:[10,10], patience:9, rarity:0, sheet:'04', cell:0, tone:'steady', short:'暗黑传奇 · 到站不是高躁动付40币，高躁动拿走40币', detail:'大亨把一切押上了赌桌。60层商店后上车、70层商店下车，不耗电、不付车费。送达时若关门不是高躁动，他付40金币；高躁动就拿走你40金币（不够就拿光）。' },
