...
export const PASSENGER_RULES: Record<PassengerKind, readonly string[]> = {
  ...
  musician: ['车内至少 4 人：每层压力 −1。', '安抚相邻的醉汉和儿童，阻止其负面效果。'],
  thief: ['没有警察或律师邻座：每层 +3 金币，偶数层压力 +1。', '有警察或律师邻座：改为每层 +1 金币，不再加压，到站车费 +5。'],
  cop: ['控制相邻的小偷，消除其加压效果。', '与炸弹客相邻：偶数层暂停引信倒计时。'],
  lawyer: ['控制相邻的小偷，消除其加压效果。不能暂停炸弹引信。'],
  drunk: ['没有音乐家或护士邻座：每层 25% 概率闹事，压力 +2，并随机与邻座换位。', '有音乐家或护士邻座：不再闹事，每层 +1 金币。'],
  nurse: ['每逢偶数层，压力 −1。', '安抚相邻的醉汉和儿童，阻止其负面效果。'],
  ...
  celebrity: ['恰好 1 位邻座：每层 +3 金币。', '至少 2 位邻座：偶数层压力 +1。没有邻座则无额外效果。'],
  inspector: ['每逢偶数层检查：总载重不超过 8，能源 +1；超过 8，压力 +1。'],
