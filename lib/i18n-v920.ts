...
const DETAIL_EN: Record<string, [string, string]> = {
  nightoperator: ['Dark legend · motor −2 power; +1 agitation/floor', 'Old Zhou’s night shift. Boards after the 60F shop and leaves at the 70F shop; uses no power and pays no fare. While aboard the motor costs 2 less power every floor (even with a full cabin), but he has turned the lights off: +1 agitation per floor. On arrival he leaves one free power-box level.'],
  ...
  kingpin: ['Dark legend · banks 7 coins/floor; +1 agitation/floor; dismissal costs 30', 'The Don’s night has no rules. Boards after the 60F shop and leaves at the 70F shop; uses no power and pays no fare. While aboard he banks 7 coins per floor, paid on arrival, and adds 1 agitation per floor. Putting him off early costs 30 coins and forfeits the bank.'],
...
export const V920_PAIRS: Array<[string, string]> = [
  ...
  ['夜班老周关灯省电', 'Night Zhou saves power in the dark'], ['冷面护士长冷藏药品', 'Cold Matron’s refrigerated drugs'], ['夜班老周关了灯', 'Night Zhou: lights out'],
