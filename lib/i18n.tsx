...
const exactPairs: Array<[string, string]> = [
  ...
  [' · 到下个补给站运转至少要 ', ' · motor to next supply stop costs at least '], [' 电，人物另计', ' power, plus riders'], ['电参考线', '-power reference reached'],
  ['三个值，六个站位', 'Three values, six positions'], ['躁动只来自人物', 'Agitation comes from riders'], ['安抚可以堆叠', 'Calming stacks'], ['十层补给', 'Supply every ten floors'], ['协作、冲突与堆叠', 'Cooperation, conflict, and stacks'],
